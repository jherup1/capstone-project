...
# NOTE: -- Test for single bounding box, no geopy, direct call async single thread
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        # Single bounding box covering a part of the eastern United States, testing for country insertion
