  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<SchoolsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SchoolsRecord> adminSchoolsSchoolsRecordList = snapshot.data!;
        return Title(
            title: 'adminSchools',
                            ...
                            children: [
                              wrapWithModel(
                                ...
                                child: const BreadcrumbsHeaderWidget(
                                  pageDetails:
                                      'Adminstrate each school or add a new one',
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          'Reference:${searchResultItem.reference.id}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Location: ${searchResultItem.myGeopoint?.toString()}',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          'Description: ${searchResultIndex.toString()}',
                                                                          style:
                                                                              FlutterFlowTheme.of(context).bodyMedium,
                                                                        ),
                                                                      ),
