  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (valueOrDefault(currentUserDocument?.role, '') == '"admin"') {
        context.pushNamed('adminSchools');
      } else {
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<SchoolsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SchoolsRecord> columnSchoolsRecordList =
                                snapshot.data!;
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children:
                                  List.generate(columnSchoolsRecordList.length,
                                      (columnIndex) {
                                final columnSchoolsRecord =
                                    columnSchoolsRecordList[columnIndex];
                                return Container(
                                  width: double.infinity,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://images.unsplash.com/photo-1580974852861-c381510bc98a?w=512&h=512',
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
