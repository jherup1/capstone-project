...
class _EditSchoolWidgetState extends State<EditSchoolWidget>
  ...
  void initState() {
    ...
    _model.schoolPicLinkTextController ??= TextEditingController();
    _model.schoolPicLinkFocusNode ??= FocusNode();
    ...
    _model.stateTextController ??=
        TextEditingController(text: widget.schoolDoc?.state);
    ...
    _model.costAfterAidTextController ??=
        TextEditingController(text: widget.schoolDoc?.tuition.toString());
    _model.costAfterAidFocusNode ??= FocusNode();

    _model.percentRecievingAidTextController ??= TextEditingController(
        text: widget.schoolDoc?.percentReceivingAId.toString());
    _model.percentRecievingAidFocusNode ??= FocusNode();
    ...
    _model.rankSortRankTextController ??= TextEditingController(
        text: widget.schoolDoc?.rankingSortRank.toString());
    _model.rankSortRankFocusNode ??= FocusNode();

    _model.actAvgTextController ??=
        TextEditingController(text: widget.schoolDoc?.actAvg.toString());
    _model.actAvgFocusNode ??= FocusNode();

    _model.satActRangeACTTextController ??=
        TextEditingController(text: widget.schoolDoc?.satActRangeACT);
    _model.satActRangeACTFocusNode ??= FocusNode();

    _model.satAvgTextController ??=
        TextEditingController(text: widget.schoolDoc?.satAvg.toString());
    _model.satAvgFocusNode ??= FocusNode();

    _model.satActRangeSATTextController ??=
        TextEditingController(text: widget.schoolDoc?.satActRangeSAT);
    _model.satActRangeSATFocusNode ??= FocusNode();

    _model.hsGpaAvgTextController ??=
    ...
    _model.busRepScoreTextController ??= TextEditingController(
        text: widget.schoolDoc?.businessRepScore.toString());
    _model.busRepScoreFocusNode ??= FocusNode();

    _model.instituationalControlTextController ??=
        TextEditingController(text: widget.schoolDoc?.institutionalControl);
    _model.instituationalControlFocusNode ??= FocusNode();

    _model.religiousAffiliationTextController ??=
        TextEditingController(text: widget.schoolDoc?.religiousAffiliation);
    _model.religiousAffiliationFocusNode ??= FocusNode();

    _model.schoolTypeTextController ??=
        TextEditingController(text: widget.schoolDoc?.schoolType);
    _model.schoolTypeFocusNode ??= FocusNode();

    _model.schoolTypeNationalTextController ??= TextEditingController(
        text: widget.schoolDoc?.schoolTypeNationalUniversities);
    _model.schoolTypeNationalFocusNode ??= FocusNode();

    _model.yearFoundedTextController ??=
        TextEditingController(text: widget.schoolDoc?.yearFounded.toString());
    _model.yearFoundedFocusNode ??= FocusNode();

    _model.settingTextController ??=
        TextEditingController(text: widget.schoolDoc?.setting);
    _model.settingFocusNode ??= FocusNode();

    _model.endowment2018TextController ??=
        TextEditingController(text: widget.schoolDoc?.endowment2018);
    _model.endowment2018FocusNode ??= FocusNode();

    _model.academicCalendarTextController ??=
        TextEditingController(text: widget.schoolDoc?.academicCalendar);
    _model.academicCalendarFocusNode ??= FocusNode();
                      ...
                      children: [
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: widget.schoolDoc?.displayName,
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: widget.schoolDoc?.description,
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: widget.schoolDoc?.schoolWebsite,
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              16.0, 16.0, 16.0, 0.0),
                          child: TextFormField(
                            controller: _model.schoolPicLinkTextController,
                            focusNode: _model.schoolPicLinkFocusNode,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                            ...
                            cursorColor: FlutterFlowTheme.of(context).primary,
                            validator: _model
                                .schoolPicLinkTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        Row(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: widget.schoolDoc?.state,
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: _model.costAfterAidFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Cost After Aid',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily:
                                    ...
                                    hintText: widget.schoolDoc?.costAfterAid
                                        .toString(),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .costAfterAidTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.percentRecievingAidTextController,
                                  focusNode:
                                      _model.percentRecievingAidFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Percent Receiving  Aid',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily:
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: _model.rankSortRankFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Sort Rank',
                                    ...
                                    hintText: widget.schoolDoc?.rankingSortRank
                                        .toString(),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .rankSortRankTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller: _model.rankIsTiedValueController ??=
                                  ...
                                  _model.rankIsTiedValue ??= widget
                                      .schoolDoc?.rankingIsTied
                                      .toString(),
                                ),
                                ...
                                isMultiSelect: false,
                                labelText:
                                    widget.schoolDoc?.rankingIsTied.toString(),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.satActRangeACTTextController,
                                  focusNode: _model.satActRangeACTFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'ACT Range',
                                    ...
                                    hintText: widget.schoolDoc?.satActRangeACT,
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.satActRangeSATTextController,
                                  focusNode: _model.satActRangeSATFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'SAT Range',
                                    ...
                                    hintText: widget.schoolDoc?.satActRangeSAT,
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .hsGpaAvgTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: _model.busRepScoreFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    ...
                                    hintText: widget.schoolDoc?.businessRepScore
                                        .toString(),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .busRepScoreTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode:
                                      _model.instituationalControlFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        widget.schoolDoc?.institutionalControl,
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.religiousAffiliationTextController,
                                  focusNode:
                                      _model.religiousAffiliationFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        widget.schoolDoc?.religiousAffiliation,
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  focusNode: _model.schoolTypeFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primary,
                                  validator: _model
                                      .schoolTypeTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.schoolTypeNationalTextController,
                                  focusNode: _model.schoolTypeNationalFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: widget.schoolDoc?.yearFounded
                                          .toString(),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .yearFoundedTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.settingFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'School Setting',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily:
                                      ...
                                      hintText: widget.schoolDoc?.setting,
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                            fontFamily:
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .settingTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.endowment2018TextController,
                                    focusNode: _model.endowment2018FocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: '2018 Endowment',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily:
                                      ...
                                      hintText: widget.schoolDoc?.endowment2018,
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                            fontFamily:
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .endowment2018TextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.academicCalendarTextController,
                                    focusNode: _model.academicCalendarFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Academic Calendar',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily:
                                      ...
                                      hintText:
                                          widget.schoolDoc?.academicCalendar,
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                            fontFamily:
                          ...
                          child: StreamBuilder<List<SchoolDataRecord>>(
                            stream: querySchoolDataRecord(
                              queryBuilder: (schoolDataRecord) =>
                                ...
                                'programRef',
                                arrayContains: widget.programDocRef,
                              ),
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<SchoolDataRecord>
                                  listViewSchoolDataRecordList = snapshot.data!;
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: const Text(
                                                                    'Confirmation'),
                                                                content: const Text(
                                                                    'Are you sure you want to remove the school from the list?'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                    ...
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              ...
                                              content: const Text(
                                                  'Are you sure you want to change this school?'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
