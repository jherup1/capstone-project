...
import 'create_school_old_model.dart';
export 'create_school_old_model.dart';

class CreateSchoolOldWidget extends StatefulWidget {
  const CreateSchoolOldWidget({super.key});

  @override
  State<CreateSchoolOldWidget> createState() => _CreateSchoolOldWidgetState();
}

class _CreateSchoolOldWidgetState extends State<CreateSchoolOldWidget>
