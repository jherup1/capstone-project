...
class _CreateSchoolWidgetState extends State<CreateSchoolWidget>
  ...
  void initState() {
    ...
    _model.aliasNameTextController ??= TextEditingController();
    ...
    _model.costAfterAidTextController ??= TextEditingController();
    ...
    _model.enrollmentTextController ??= TextEditingController();
    ...
    _model.displayRankTextController ??= TextEditingController();
    ...
    _model.actAvgTextController ??= TextEditingController();
    _model.actAvgFocusNode ??= FocusNode();

    _model.satActRangeACTTextController ??= TextEditingController();
    _model.satActRangeACTFocusNode ??= FocusNode();

    _model.satAvgTextController ??= TextEditingController();
    _model.satAvgFocusNode ??= FocusNode();

    _model.satActRangeSATTextController ??= TextEditingController();
    _model.satActRangeSATFocusNode ??= FocusNode();

    _model.hsGpaAvgTextController ??= TextEditingController();
    ...
    _model.instituationalControlTextController ??= TextEditingController();
    _model.instituationalControlFocusNode ??= FocusNode();

    _model.religiousAffiliationTextController ??= TextEditingController();
    _model.religiousAffiliationFocusNode ??= FocusNode();

    _model.schoolTypeTextController ??= TextEditingController();
    ...
    _model.settingTextController ??= TextEditingController();
    _model.settingFocusNode ??= FocusNode();

    _model.endowment2018TextController ??= TextEditingController();
    _model.endowment2018FocusNode ??= FocusNode();

    _model.academicCalendarTextController ??= TextEditingController();
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'University of Nevada, Reno',
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText:
                                  'The University of Nevada, Reno has a great psychology program.',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        'UNR, 1664 N. Virginia St, Reno,  NV, 89557',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'national-universities',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          fontFamily:
