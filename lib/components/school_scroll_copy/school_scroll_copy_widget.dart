...
class SchoolScrollCopyWidget extends StatefulWidget {
  const SchoolScrollCopyWidget({
    super.key,
    this.state,
  });
  ...
  @override
  State<SchoolScrollCopyWidget> createState() => _SchoolScrollCopyWidgetState();
}

class _SchoolScrollCopyWidgetState extends State<SchoolScrollCopyWidget> {
  late SchoolScrollCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SchoolScrollCopyModel());
    ...
    return Container(
      ...
      child: StreamBuilder<List<SchoolDataRecord>>(
        stream: querySchoolDataRecord(
          queryBuilder: (schoolDataRecord) => schoolDataRecord.where(
            'state',
                            ...
                            await showModalBottomSheet(
                              ...
                              builder: (context) {
                                return Padding(
                                  ...
                                  child: SchoolInformationBottomWidget(
                                    school: listViewSchoolDataRecord,
                                  ),
                                );
                              },
