...
class EditSchoolOLDWidget extends StatefulWidget {
  const EditSchoolOLDWidget({
    super.key,
  ...
  @override
  State<EditSchoolOLDWidget> createState() => _EditSchoolOLDWidgetState();
}

class _EditSchoolOLDWidgetState extends State<EditSchoolOLDWidget>
    with TickerProviderStateMixin {
  late EditSchoolOLDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditSchoolOLDModel());
