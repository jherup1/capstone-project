...
import 'edit_user_o_l_d_model.dart';
export 'edit_user_o_l_d_model.dart';

class EditUserOLDWidget extends StatefulWidget {
  const EditUserOLDWidget({
    super.key,
    this.userDoc,
  });
  ...
  @override
  State<EditUserOLDWidget> createState() => _EditUserOLDWidgetState();
}

class _EditUserOLDWidgetState extends State<EditUserOLDWidget>
    with TickerProviderStateMixin {
  late EditUserOLDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditUserOLDModel());
