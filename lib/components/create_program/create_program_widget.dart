...
class CreateProgramWidget extends StatefulWidget {
  const CreateProgramWidget({super.key});

  @override
  State<CreateProgramWidget> createState() => _CreateProgramWidgetState();
}

class _CreateProgramWidgetState extends State<CreateProgramWidget>
    with TickerProviderStateMixin {
  late CreateProgramModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProgramModel());
    ...
    _model.programWebsiteTextController ??= TextEditingController();
    _model.programWebsiteFocusNode ??= FocusNode();

    _model.programPhotoLinkTextController ??= TextEditingController();
    _model.programPhotoLinkFocusNode ??= FocusNode();

    _model.programJobsTextController ??= TextEditingController();
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            focusNode: _model.programPhotoLinkFocusNode,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: 'Program Image Link',
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.url,
                            cursorColor: FlutterFlowTheme.of(context).primary,
                            validator: _model.programJobsTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ],
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (confirmDialogResponse) {
                                  await ProgramDataRecord.collection
                                      .doc()
                                      .set(createProgramDataRecordData(
                                        programName: _model
                                        ...
                                        programDescription: _model
                                            ...
                                            .text,
                                        programImage: _model
                                            .programPhotoLinkTextController
                                            .text,
